...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = $db->prepare("SELECT * FROM doctor WHERE email = :email AND password_doctor = :password");
...
<section>
    <div class="container">
        ...
        <form action="input-doctor-login.php" method="POST">
            <div class="form">
                <div class="info">
